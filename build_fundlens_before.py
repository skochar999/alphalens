...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out",     default="./alphalens_before.html")
    return p.parse_args()
    ...
    <div style="display:grid;grid-template-columns:1fr auto;gap:48px;align-items:center;text-align:left">
      <div>
        ...
        <div class="hero-stats" style="justify-content:flex-start">
          <div class="stat-pill">
            <span class="sp-num" style="color:var(--red)">73%</span>
            <div class="sp-label">large-cap funds<br>lost to the index</div>
          </div>
          <div class="stat-pill">
            <span class="sp-num" style="color:var(--red)">82%</span>
            <div class="sp-label">mid/small-cap funds<br>lost to the index</div>
          </div>
          <div class="stat-pill">
            <span class="sp-num" style="color:var(--accent)">{stats['n_funds']}</span>
            <div class="sp-label">funds ranked<br>daily by AlphaLens</div>
          </div>
        </div>
        <div style="margin-top:10px;font-size:11px;color:var(--muted)">
          Source: SPIVA India Mid-Year 2025 · 10-year period · S&P Dow Jones Indices
        </div>
      </div>
...
<!-- SECTION: THE UNCOMFORTABLE TRUTH (before version) -->
<section id="how-it-works" style="background:var(--bg2);border-top:1px solid var(--border);padding:72px 0">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:start">
      <div>
        <div class="section-label">The uncomfortable truth</div>
        <h2 class="section-title">Most active funds fail.<br>But the ones that don't<br>change everything.</h2>
        <p style="font-size:15px;color:var(--muted);line-height:1.85;margin-bottom:20px">
          SPIVA India data shows that over a 10-year period, <strong style="color:var(--text)">73% of large-cap</strong>
          and <strong style="color:var(--text)">82% of mid &amp; small-cap</strong> active funds failed to beat their
          benchmark index. That's the honest reality.
        </p>
        <p style="font-size:15px;color:var(--muted);line-height:1.85;margin-bottom:20px">
          But here's what that data also tells you: <strong style="color:var(--text)">roughly 1 in 4 active funds
          do beat the index</strong> — and they beat it by a meaningful margin. The difference between
          the right fund and the wrong one, compounded over 15 years, can be worth
          <strong style="color:var(--green)">lakhs of rupees</strong>.
        </p>
        <p style="font-size:15px;color:var(--muted);line-height:1.85">
          We're not saying avoid index funds — they're low-cost, efficient, and should form
          the core of most portfolios. But for true wealth creation,
          <strong style="color:var(--text)">a portion of your portfolio belongs in the best actively managed funds</strong>.
          The challenge is finding them. That's what AlphaLens is built to do.
        </p>
      </div>
      <div>
        <div style="background:var(--bg3);border-radius:16px;padding:28px">
          <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:var(--muted);margin-bottom:20px">10-year performance · SPIVA India 2025</div>
          <div style="margin-bottom:20px">
            <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:6px">
              <span style="font-weight:600;color:var(--text)">Large Cap</span>
              <span style="color:var(--muted)">vs S&P India LargeMidCap Index</span>
            </div>
            <div style="display:flex;height:28px;border-radius:6px;overflow:hidden;gap:2px">
              <div style="width:73%;background:rgba(220,38,38,0.15);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:var(--red)">73% underperformed</div>
              <div style="width:27%;background:rgba(5,150,105,0.15);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:var(--green)">27% beat</div>
            </div>
          </div>
          <div style="margin-bottom:24px">
            <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:6px">
              <span style="font-weight:600;color:var(--text)">Mid &amp; Small Cap</span>
              <span style="color:var(--muted)">vs S&P India benchmarks</span>
            </div>
            <div style="display:flex;height:28px;border-radius:6px;overflow:hidden;gap:2px">
              <div style="width:82%;background:rgba(220,38,38,0.15);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:var(--red)">82% underperformed</div>
              <div style="width:18%;background:rgba(5,150,105,0.15);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:var(--green)">18%</div>
            </div>
          </div>
          <div style="font-size:11px;color:var(--muted);line-height:1.6">Source: SPIVA India Mid-Year 2025 · S&P Dow Jones Indices · 10-year period ending June 2025</div>
        </div>
        <div style="margin-top:16px;background:#fff;border:1.5px solid rgba(59,110,232,0.2);border-radius:12px;padding:20px 22px">
          <div style="font-size:12px;font-weight:700;color:var(--accent);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:10px">Our philosophy</div>
          <p style="font-size:14px;color:var(--muted);line-height:1.75;margin:0">Index funds for the core. <strong style="color:var(--text)">The best active funds for the edge.</strong> We help you find the small minority that genuinely outperform, and know when to switch.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- SECTION: PROOF IT WORKS (before version — full detail + calculator) -->
<section style="background:var(--bg2);border-top:1px solid var(--border);padding:72px 0">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:center">
      <div>
        <div class="section-label">Proof it works · Backtest May 2024 – May 2026</div>
        <h2 class="section-title">On a regular plan basis, the average fund <em style="color:var(--red)">loses to its benchmark</em>. AlphaLens picks don't.</h2>
        <p style="font-size:15px;color:var(--muted);line-height:1.85;margin-bottom:28px">
          We tracked how our top-ranked funds actually performed after we ranked them — using only data available at the time, no hindsight. All returns shown on regular plan basis after fees.
        </p>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
          <div style="background:rgba(5,150,105,0.06);border:1.5px solid rgba(5,150,105,0.25);border-radius:12px;padding:20px">
            <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:var(--green);margin-bottom:8px">AlphaLens top picks</div>
            <div style="font-size:36px;font-weight:800;color:var(--green);letter-spacing:-1px">69%</div>
            <div style="font-size:13px;color:var(--muted);margin-top:4px">beat their benchmark</div>
            <div style="font-size:14px;font-weight:700;color:var(--green);margin-top:6px">+4.3pp/yr avg active return</div>
          </div>
          <div style="background:var(--bg3);border:1px solid var(--border);border-radius:12px;padding:20px">
            <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:var(--muted);margin-bottom:8px">Average regular plan fund</div>
            <div style="font-size:36px;font-weight:800;color:var(--muted);letter-spacing:-1px">49%</div>
            <div style="font-size:13px;color:var(--muted);margin-top:4px">beat their benchmark</div>
            <div style="font-size:13px;color:var(--muted);margin-top:6px;line-height:1.5">Most lose to their benchmark<br>after fees are deducted</div>
          </div>
        </div>
        <div style="margin-top:14px;background:rgba(5,150,105,0.06);border:1px solid rgba(5,150,105,0.2);border-radius:8px;padding:12px 16px;font-size:13px;color:var(--muted)">
          AlphaLens picks beat the average regular plan fund by <strong style="color:var(--green)">+20 percentage points</strong> in hit rate.
        </div>
      </div>
      <!-- Calculator -->
      <div style="background:var(--bg3);border-radius:16px;padding:28px;border:1px solid var(--border)">
        <div style="font-size:13px;font-weight:700;color:var(--text);margin-bottom:20px">See the difference for yourself</div>
        <div style="display:flex;gap:0;background:var(--bg4);border-radius:8px;padding:3px;margin-bottom:20px;width:fit-content">
          <button id="modeLS" onclick="calcSetMode('lumpsum')" style="padding:7px 20px;border-radius:6px;border:none;font-size:13px;font-weight:600;cursor:pointer;background:var(--accent);color:#fff">Lump Sum</button>
          <button id="modeSIP" onclick="calcSetMode('sip')" style="padding:7px 20px;border-radius:6px;border:none;font-size:13px;font-weight:600;cursor:pointer;background:transparent;color:var(--muted)">Monthly SIP</button>
        </div>
        <div style="margin-bottom:16px">
          <label style="font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);display:block;margin-bottom:6px" id="amtLabel">Investment amount (₹)</label>
          <input type="number" id="calcAmount" value="100000" min="1000" step="1000" oninput="calcUpdate()" style="width:100%;padding:10px 14px;border:1px solid var(--border);border-radius:8px;font-size:15px;font-weight:600;background:#fff;color:var(--text)">
        </div>
        <div style="margin-bottom:24px">
          <label style="font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);display:block;margin-bottom:6px">Time horizon: <span id="yearsLabel">15 years</span></label>
          <input type="range" id="calcYears" min="5" max="25" value="15" step="1" oninput="calcUpdate()" style="width:100%;accent-color:var(--accent)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px">
          <div style="background:#fff;border-radius:10px;padding:14px;border:1px solid rgba(5,150,105,0.2)">
            <div style="font-size:10px;text-transform:uppercase;letter-spacing:.05em;color:var(--green);font-weight:700;margin-bottom:4px">AlphaLens picks</div>
            <div id="calcAlpha" style="font-size:22px;font-weight:800;color:var(--text);letter-spacing:-0.5px">₹10.67L</div>
          </div>
          <div style="background:#fff;border-radius:10px;padding:14px;border:1px solid var(--border)">
            <div style="font-size:10px;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);font-weight:700;margin-bottom:4px">Average fund</div>
            <div id="calcAvg" style="font-size:22px;font-weight:800;color:var(--muted);letter-spacing:-0.5px">₹5.93L</div>
          </div>
        </div>
        ...
        <p style="font-size:10px;color:var(--muted);margin-top:12px;line-height:1.6">AlphaLens rate: 16.3%/yr · Average regular plan fund: 11.3%/yr · Illustrative only. Past performance is not indicative of future results.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container-wide">
    ...
    <div class="table-wrap">
      <table>
        <thead>
          <tr>
            <th data-key="rank"    onclick="sortBy('rank')">#</th>
...
function renderTable() {{
  ...
  slice.forEach(f => {{
    ...
    tr.innerHTML = `
      <td class="td-r" style="color:var(--muted)">${{globalRank[f.code] || "—"}}</td>
